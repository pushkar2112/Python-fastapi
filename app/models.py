...
class Post(Base):
    ...
    owner = relationship("User") # Refer to the sqlalchemy model class
...
class Vote(Base):
    ...
    post_id = Column(Integer, ForeignKey("posts.id", ondelete="CASCADE"), primary_key=True) # ondelete cascade to delete all the votes if the post is deleted